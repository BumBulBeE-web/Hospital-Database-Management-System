...
class Hospital:
        ...
        def __init__(self,root):
                ...
                lbltitle=Label(self.root,bd=20, relief=RIDGE, text="+ HINDALCO HOSPITAL MANAGEMENT SYSTEM +",fg='red',bg='white',font=("times new roman",45,"bold"))
...
#===================DATA FRAME LEFT========================= 
        ...
        #using grid to make inside our frame
                ...
                lblNoofTable=Label(DataframeLeft, font=("arial",12,"bold"), text="Number of Table :",padx=2,pady=6)
                lblNoofTable.grid(row=3,column=0,sticky=W)
                txtNoofTable=Entry(DataframeLeft, font=("arial",13,"bold"),textvariable=self.NumberofTablets, width=35)
                ...
                lblStorage=Entry(DataframeLeft, font=("arial",12,"bold"),textvariable=self.StrorageAdvice, width=35)
                ...
                lblMedicine.grid(row=3,column=3,stick=W)
                ...
                lblNHSNumber=Entry(DataframeLeft, font=("arial",12,"bold"),textvariable=self.nhsNumber, width=35)
 ...
 #=============================BUTTONS=======================================
                ...
                btnPrescription=Button(Buttonframe,command=self.iPrescription,text="Prescription",bg="green",fg= "white",font=("arial",12,"bold"),padx=2,pady=6,width=23)
                btnPrescription.grid(row=0,column=0)

                btnPrescriptionData=Button(Buttonframe,command=self.iPrescriptionDate, text="Prescription Data", bg= "green", fg= "white", font=("arial",12,"bold"),width=23,padx=2,pady=6)
...
#============================Functionality Decleration==================================
        ...
        def iPrescriptionDate(self):
                if self.Nameoftablets.get()=="" or self.ref.get()=="":
                        messagebox.showerror("Message","All Fields Are Require To Fill")
                else:
                        conn=mc.connect(host="localhost",username="root",password="root",database="hospitaldata")
                        my_cursor=conn.cursor()
                        #using (get) to store data in database
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Prescription","Record has been inserted successfully")
        ...
        def iPrescription(self):
                ...
                self.txtPrescription.insert(END,"Lots:\t\t\t" + self.Lot.get() + "\n")
                ...
                self.txtPrescription.insert(END,"StrorageAdvice:\t\t\t" + self.StrorageAdvice.get() + "\n")
        ...
        def idelete(self):
                ...
                conn.close()
                self.fetch_data()
                messagebox.showinfo("Delete","Patients record has been deleted successfully")
...
#----------------when we are moving our cursor towards the data below it is fetching the data and showing it to on the table----------
